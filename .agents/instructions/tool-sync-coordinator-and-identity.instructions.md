...
| `tools_skipped`            | `usize`                  | Tools skipped because their canonical version was already provisioned. Shown in the resolve bar with `set_suffix_components(SuffixComponents { custom: "skipped" })`. |
