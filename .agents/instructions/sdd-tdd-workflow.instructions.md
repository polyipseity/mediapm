...
### ANSI-safe progress prefix and message truncation
...
| `max_prefix_width`/`max_message_width` threshold at 60 cols                                                   | `max_prefix_width_wide`, `max_prefix_width_narrow`, `max_message_width_wide`, `max_message_width_narrow`                                                                                                                                                   | [covered] |
| `semantic_truncate_prefix`: empty→empty, already fits→unchanged                                               | `semantic_truncate_prefix_empty`, `semantic_truncate_prefix_already_fits`                                                                                                                                                                                  | [covered] |
| `semantic_truncate_prefix`: progressive section removal (version → count → phase → tool name → hard truncate) | `semantic_truncate_prefix_remove_version`, `semantic_truncate_prefix_remove_version_and_count`, `semantic_truncate_prefix_remove_version_count_phase`, `semantic_truncate_prefix_remove_version_full`                                                      | [covered] |
| `semantic_truncate_prefix`: hard truncate fallback when no sections available                                 | `semantic_truncate_prefix_hard_truncate`                                                                                                                                                                                                                   | [covered] |
| `semantic_truncate_prefix`: accounts for failed/abandoned prefix overhead                                     | `semantic_truncate_prefix_failed_overhead`                                                                                                                                                                                                                 | [covered] |
| `semantic_truncate_message`: empty→empty, already fits→unchanged                                              | `semantic_truncate_message_empty`, `semantic_truncate_message_fits`                                                                                                                                                                                        | [covered] |
| `semantic_truncate_message`: no separator → hard truncate                                                     | `semantic_truncate_message_no_separator`                                                                                                                                                                                                                   | [covered] |
| `semantic_truncate_message`: custom part removal (partial and all)                                            | `semantic_truncate_message_remove_custom_partial`, `semantic_truncate_message_remove_custom_all`                                                                                                                                                           | [covered] |
| `semantic_truncate_message`: hard truncate fallback after custom fully removed                                | `semantic_truncate_message_hard_truncate`                                                                                                                                                                                                                  | [covered] |
| Wire point: prefix truncation in `sync_snapshot_to_bar` (single authoritative push point)                     | Verified by existing integration tests (`progress_output` suite passes with no regressions)                                                                                                                                                                | [covered] |
| Wire point: message truncation in `sync_snapshot_to_bar`                                                      | Verified by existing integration tests (`progress_output` suite passes with no regressions)                                                                                                                                                                | [covered] |
| ANSI overhead from `build_prefix` accounted for in prefix width budget                                        | Verified by ANSI overhead calculation in `sync_snapshot_to_bar`                                                                                                                                                                                            | [covered] |
| Redundant `set_prefix` removed from `sync_slot` (delegates to `sync_snapshot_to_bar`)                         | Verified by compilation and all integration tests                                                                                                                                                                                                          | [covered] |
| All truncation functions are pure, never panic, idempotent                                                    | (architectural invariant — verified by test coverage across all edge cases)                                                                                                                                                                                | [covered] |
