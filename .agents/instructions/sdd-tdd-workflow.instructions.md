...
| Spec item                                                                                              | Test(s)                                                                                                                                                                                                                                                    | Status    |
| ------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| `strip_ansi` strips SGR escape sequences (`\x1b[...m`) only                                            | `strip_ansi_sgr_only`, `strip_ansi_non_sgr_preserved`                                                                                                                                                                                                      | [covered] |
...
| `shrink_range_to_budget` removes visible chars from right end of byte range                            | `shrink_range_to_budget_noop_when_fits`, `shrink_range_to_budget_remove_some`, `shrink_range_to_budget_remove_all`, `shrink_range_to_budget_empty_range`, `shrink_range_to_budget_empty_result`, `shrink_range_to_budget_unicode_respects_char_boundaries` | [covered] |
| `shrink_range_to_budget` handles Unicode char boundaries correctly                                     | `shrink_range_to_budget_unicode_respects_char_boundaries`                                                                                                                                                                                                  | [covered] |
| `prefix_overhead` returns 4 for failed/abandoned, 0 otherwise                                          | `prefix_overhead_failed`, `prefix_overhead_abandoned`, `prefix_overhead_active`                                                                                                                                                                            | [covered] |
| `max_prefix_width` / `max_suffix_width` threshold at 60 cols                                           | `max_prefix_width_wide`, `max_prefix_width_narrow`, `max_suffix_width_wide`, `max_suffix_width_narrow`                                                                                                                                                     | [covered] |
...
| `semantic_truncate_suffix`: empty, already-fits, no-separator, hard-truncate edge cases                | `semantic_truncate_suffix_empty`, `semantic_truncate_suffix_hard_truncate`, `semantic_truncate_suffix_no_separator`                                                                                                                                        | [covered] |
...
| `set_prefix(String)` string API parses into components via `prefix_components_from_str`               | `recording_set_prefix_ops`, `prefix_components_from_str_*`                                                                                                                                                                                                  | [covered] |
...
| `RecordingTrackedHandle` records `ProgressOp::SetPrefixComponents` / `ProgressOp::SetSuffixComponents` | `recording_set_prefix_components_ops`, `recording_set_suffix_components_ops`                                                                                                                                                                               | [covered] |
