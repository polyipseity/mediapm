...
| `SharedState` stores `prefix_components` and `suffix_components`                                       | (compilation — no raw string prefix/suffix fields remain)                                                                                                                                                                                                  | [covered] |
| `TrackSnapshot` has both rendered strings and component source data                                    | (compilation + `snapshot()` access in `sync_snapshot_to_bar`)                                                                                                                                                                                              | [covered] |
| `TrackedHandle::set_prefix_components` / `set_suffix_components`                                       | (compilation + all caller updates)                                                                                                                                                                                                                         | [covered] |
| `set_prefix(String)` backward compat with heuristic parse                                              | `set_prefix_heuristic_parse_tool_name_version_phase_count`, `set_prefix_heuristic_parse_tool_name_only`                                                                                                                                                    | [covered] |
| `set_suffix(String)` backward compat (wraps `SuffixComponents`)                                        | (compilation — trivial delegation)                                                                                                                                                                                                                         | [covered] |
...
| Separator between auto and custom in suffix: `" "` (single space, verified in integration test)       | `transition_exact_abandon_with_message_and_overall` (expected output updated to single space)                                                                                                                                                               | [covered] |
