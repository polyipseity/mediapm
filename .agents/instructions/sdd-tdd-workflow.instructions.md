...
| `SuffixComponents` struct (custom)                                                                        | (compilation — trivially wraps `String`)                                                                                                                                                                                                       | [covered] |
...
| `semantic_truncate_suffix` takes `(auto, custom)` directly (no `rfind("  ")`)                             | `semantic_truncate_suffix_fits`, `semantic_truncate_suffix_remove_custom_partial`, `semantic_truncate_suffix_remove_custom_all`                                                                                                                | [covered] |
