...
| Normative truncation spec documented verbatim in code doc comments (both removal orders, storage rule, marker render rule) | Doc comments on `SuffixComponents` (~840), `PrefixComponents` (~871), `render_prefix_components` (~909), `semantic_truncate_prefix` (~1106), `semantic_truncate_suffix` (~1205)                                                                 | [covered] |
