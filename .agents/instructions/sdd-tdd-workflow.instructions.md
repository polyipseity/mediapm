...
| `PreResolveOutcome::Skip` carries `metadata_cached: bool`                                     | `skip_bar_shows_skipped_cached_when_metadata_cached`, `skip_bar_shows_skipped_when_metadata_not_cached`                                                                                              | 🟢     |
| Resolve bar shows `"cached"` message when metadata_cached=true                                | `resolve_bar_shows_cached_when_metadata_cached`                                                                                                                                                      | 🟢     |
...
| Skip bar shows `"skipped (cached)"` vs `"skipped"` depending on metadata_cached               | `skip_bar_shows_skipped_cached_when_metadata_cached`, `skip_bar_shows_skipped_when_metadata_not_cached`                                                                                              | 🟢     |
