...
- Before documenting build, test, lint, format, type-check, packaging, release, or automation workflows, inspect the files that define them.
- Treat workflow files, scripts, editor settings, manifests, lockfiles, and config files as the primary evidence for how the repo actually works.
