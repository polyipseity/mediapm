...
*Sections derived from the deleted `crate-specifications.md` and `elaboration-pass-edge-cases.md` (commit `d6aa286`). See per-crate `AGENTS.md` files for crate-specific edge cases and invariants.*
