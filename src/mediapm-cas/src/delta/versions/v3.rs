...
use crate::delta::versions::v2::DeltaStateV2;
...
impl V3Envelope {
    ...
    pub(crate) fn parse(bytes: &[u8]) -> Result<V3Envelope, CasError> {
        ...
        let (base_hash, hash_len) = super::parse_multihash_from_bytes(remaining)
...
impl From<V3Envelope> for DeltaStateV3 {
    fn from(envelope: V3Envelope) -> Self {
        DeltaStateV3 {
