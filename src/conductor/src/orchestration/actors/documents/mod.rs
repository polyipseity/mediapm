...
impl DocumentLoaderClient {
    ...
    pub(in crate::orchestration) async fn load_and_unify(
        ...
        .map_err(|err| ConductorError::rpc_error("document loader load_and_unify", err))?
    }
    ...
    pub(in crate::orchestration) async fn persist_machine_document(
        ...
        .map_err(|err| ConductorError::rpc_error("document loader persist_machine_document", err))?
    }
    ...
    pub(in crate::orchestration) async fn persist_state_document(
        ...
        .map_err(|err| ConductorError::rpc_error("document loader persist_state_document", err))?
    }
}
...
impl DocumentLoaderActor {
    ...
    fn persist_machine_document(
        ...
        let encoded = with_generated_banner(
            encode_machine_document(document.clone())?,
            concat!(
                "# @generated by mediapm\n",
                "# This file is machine-managed. Prefer editing mediapm.ncl for user intent.\n\n",
            ),
        );
        write_if_changed(path, &encoded, "writing conductor.machine.ncl")
    }
    ...
    fn persist_state_document(
        ...
        let encoded = with_generated_banner(
            encode_state_document(document.clone())?,
            concat!(
                "# @generated by mediapm\n",
                "# This file is runtime-managed volatile state and may be rewritten frequently.\n\n",
            ),
        );
        write_if_changed(path, &encoded, "writing .conductor/state.ncl")
    }
...
/// Writes one file only when contents changed.
