...
- The monolithic `crate-specifications.md` and
  `elaboration-pass-edge-cases.md` have been deleted. All specification and
  edge-case content is now inlined above or linked via
  `.agents/instructions/spec-development-index.instructions.md`.
- Keep this conductor-local guide as the authoritative source for
  orchestration/config/tool invariants.
