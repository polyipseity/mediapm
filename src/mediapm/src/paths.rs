...
pub struct MediaPmPaths {
    ...
    /// Tool-specific runtime cache generated by `mediapm`.
...
impl MediaPmPaths {
    ...
    pub fn from_root(root_dir: impl Into<PathBuf>) -> Self {
        ...
        Self {
            ...
            tools_dir: runtime_root.join("cache"),
            runtime_root,
            root_dir,
        }
    }
...
mod tests {
    ...
    fn default_paths_use_dot_mediapm_root() {
        ...
        assert_eq!(paths.tools_dir, root.path().join(".mediapm").join("cache"));
    }
    ...
    fn runtime_storage_overrides_resolve_with_split_roots() {
        ...
        assert_eq!(resolved.tools_dir, root.path().join(".mediapm-runtime").join("cache"));
    }
}
